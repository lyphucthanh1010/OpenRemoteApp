    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rlt1.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                LayoutInflater li = LayoutInflater.from(ActivityWeatherData.this);
                View customDialogView = li.inflate(R.layout.custom_dialog, null);
                final AlertDialog alertDialogBuilder  = new AlertDialog.Builder(ActivityWeatherData.this).create();
                ...
                graphDatabaseHelper = new GraphDatabaseHelper(ActivityWeatherData.this);
